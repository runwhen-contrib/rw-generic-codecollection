...
*** Tasks ***
Run Curl Command and Add Non-Empty Result to Report in `${TASK_TITLE}`
...
Suite Initialization
    ...
    Run Curl Command and Add Non-Empty Result to Report in `${TASK_TITLE}`=    RW.Core.Import User Variable    TASK_TITLE
    ...    type=string
