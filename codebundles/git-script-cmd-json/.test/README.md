# Test Scripts for git-script-cmd-json
...
```bash
export METRIC_MODE=output
export SCRIPT_COMMAND="bash /home/runwhen/codecollection/codebundles/git-script-cmd-json/.test/test-output-mode.sh"
```
...
```bash
METRIC_MODE=output
SCRIPT_COMMAND="bash codebundles/git-script-cmd-json/.test/test-output-failure.sh"
```
...
SCRIPT_COMMAND="bash codebundles/git-script-cmd-json/.test/test-returncode-mode.sh"
```
