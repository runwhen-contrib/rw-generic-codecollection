...
*** Tasks ***
Run Kubectl Command and Determine Health Score for `${KUBECTL_COMMAND}`
...
Suite Initialization
    ...
    Run Kubectl Command and Determine Health Score for `${KUBECTL_COMMAND}`=    RW.Core.Import User Variable    TASK_TITLE
    ...    type=string
